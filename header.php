...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="<?php echo get_template_directory_uri(); ?>/assets/img/design/MarkerLogo.png">
    ...
    <div class="header">
        <div class="header-logo">
            <a href="https://tpumarker.net/">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/img/design/MarkerLogoWhite.png" alt="">
            </a>
        </div>
        <script>
            $(function(){
